...
const config = {
  SESSION_ID: process.env.SESSION_ID || "HAIKO~MDX~PdRS0RBT#WfSv7AZcHvmaWM638RwJMqA0kvbAxenQzVkMrEOVd7U",
  ...
  BOT_NAME: process.env.BOT_NAME || "VAIANA DRAGNIR",
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/voqg33.jpg",
  DESCRIPTION: process.env.DESCRIPTION || "WELCOME TO LA REINE VAIANA DRAGNIR",
  OWNER_NAME: process.env.OWNER_NAME || "VAIANA",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "50947542824",
